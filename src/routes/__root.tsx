...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "DOSSIER X — Truth hides in the details." },
      {
          ...
          "@graph": [
            {
              ...
              name: SITE_NAME,
              description:
                "A document-driven detective investigation game. Analyze fictional case files, follow the evidence, and solve the case yourself.",
              inLanguage: "en",
            },
            {
              "@type": "VideoGame",
              ...
              description:
                "DOSSIER X is a browser-based detective investigation game. Players analyze fictional crime scene photos, evidence, suspect dossiers, and witness statements to identify the culprit and earn a case-closed certificate.",
              ...
              author: {
                "@type": "Organization",
                name: "Dossier X — Special Investigation Division",
              },
            },
          ],
        }),
