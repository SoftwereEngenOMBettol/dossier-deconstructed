...
export const Route = createFileRoute("/_app/achievements")({
  head: () =>
    seo({
      title: "Achievements — Investigation Milestones | DOSSIER X",
      description: "Track your DOSSIER X achievements: cases solved, evidence examined, and investigation milestones unlocked.",
      path: "/achievements",
    }),
