...
export const Route = createFileRoute("/_app/casepacks")({
  head: () =>
    seo({
      title: "Case Packs — Import New Investigations | DOSSIER X",
      description: "Download and import DOSSIER X case packs to add new fictional criminal investigations to your archive.",
      path: "/casepacks",
    }),
