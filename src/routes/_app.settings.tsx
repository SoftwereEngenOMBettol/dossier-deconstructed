...
export const Route = createFileRoute("/_app/settings")({
  head: () =>
    seo({
      title: "Settings — Detective Profile | DOSSIER X",
      description: "Manage your DOSSIER X detective profile and imported case data.",
      path: "/settings",
    }),
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-8 py-6 sm:py-10">
      ...
      <section className="mt-10 rounded-lg border border-border bg-card/60 p-6">
        ...
        <label htmlFor="display-name" className="mt-4 block text-[10px] uppercase tracking-widest text-muted-foreground">
          Display Name
        </label>
        <input
          id="display-name"
